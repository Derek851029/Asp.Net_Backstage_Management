        ...
        function Setup() {
            ...
            if (confirm("確認要新增修改行程嗎")) {
                $.ajax({
                    ...
                    type: 'POST',
                    //async: false,
                    data: JSON.stringify({ day: day, str_s: str_s, Agent_Name: str_j_a }),
                    contentType: 'application/json; charset=UTF-8',
                    dataType: "json",       //如果要回傳值，請設成 json
                    success: function (data) {
                        var json = JSON.parse(data.d.toString());
    ...
    <div class="table-responsive" style="text-align: center; width:500px; margin: 10px 20px">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <button id="Button5" type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="" style="width: 110px; height: 65px" onclick="ONE()">
                            <span class=''></span>&nbsp;一&nbsp;</button>
                        <button id="Button6" type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="" style="width: 110px; height: 65px" onclick="TWO()">
                            <span class=''></span>&nbsp;二&nbsp;</button>
                        <button id="Button7" type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="" style="width: 110px; height: 65px" onclick="THREE()">
                            <span class=""></span>&nbsp;三&nbsp;</button>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="modal-dialog" style="width: 1100px;">
            ...
            <!--                <tr>
                            ...
                            <tr>
                                ...
                                <th style="text-align: center;">
                                    <button id="Button4" type="button" class="btn btn-primary btn-lg" onclick="Setup()"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;排定規劃</button>
                                </th>
                                <th>
