...
public partial class _0030010002 : System.Web.UI.Page
{
    ...
    public static string GetClassGroup(DateTime start, DateTime end, string time)
    {
      ...
      string sqlstr = @"select  Type_Value + '. ' + Type +' '+ Convert(nvarchar(4),count(*)) as title, Type as type, Type_Value as value, CONVERT(varchar(100), SetupTime, 111) as start " +
    ...
    public static string URL(string mno)
    {
        ...
        string str_url = "../0030010099.aspx?seqno=" + mno;         //打開10099 並放入同Case_ID號的資料
