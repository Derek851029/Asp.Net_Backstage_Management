...
public partial class _0030010004 : System.Web.UI.Page
{
    ...
    public static string GetClassGroup(DateTime start, DateTime end, string time)
    {
        ...
        //" where Con_Company != 'MA_Sales' " +
        " GROUP by Type,CONVERT(varchar(100), SetupDate, 111) ";      //Con_Company, 
            var a = DBTool.Query<T_0030010004_2>(sqlstr, new      //行事曆案件整理
            {
                startDate = start,
                ednDate = end,
        ...
        " CONVERT(varchar(100), SetupDate, 111) as start " +
        " FROM [DimaxCallcenter].[dbo].[OE_Data] " +
                //" where Con_Company in( @Agent_Company2, 'MA_Sales') " +
        ...
        else if (Agent_Name == "簡鴻儒")
        {
            ...
            " GROUP by Con_Company,Type,CONVERT(varchar(100), SetupDate, 111) ";

            var c = DBTool.Query<T_0030010004_2>(Sqlstr, new      //行事曆案件整理
            {
                startDate = start,
                ednDate = end,
                Agent_Company2 = Value1(Agent_Company1),
    ...
    public static string GetClassScheduleList(DateTime date, string Type)       //案件列表程式
    {
            ...
            (Agent_Name == "呂子斌"))  //看全部2
        {
            ...
            " FROM OE_Data " +
            " WHERE Type = @Type AND CONVERT(varchar(100), SetupDate, 111) = @date "+
            " ";      // and  Con_Company in( @Agent_Company2, 'MA_Sales')
        ...
        else if (Agent_Name == "簡鴻儒")
        {
            ...
            " and Con_Company in('Sales 1','Sales 2','Sales 3') ";      // 原始的不會 Group    CONVERT(varchar(100), Upload_Time, 111) 要整串放進 Group 中
    ...
    public static string URL(string mno)
    {
        ...
        string str_url = "../0030010005.aspx?seqno=" + mno;         //打開10099 並放入同Case_ID號的資料
    ...
    public class T_0030010004_2
    {
        ...
        public string Agent_Company1 { get; set; }
