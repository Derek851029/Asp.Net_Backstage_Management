<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="0030010007.aspx.cs" Inherits="_0030010007" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="head2" runat="Server">
    ...
    <script>
        ...
        function renderCalendar() {
            $('#calendar').fullCalendar({
                ...
                eventClick: function (calEvent, jsEvent, view) {
                    ...
                    var url = "0030010007.aspx?date=" + calEvent.start.format("YYYY-MM-DD") + "&type=" + calEvent.type;
                    location.href = (url);
                },
                eventAfterRender: function (calEvent, jsEvent, view) {
                    //  類型  1：尚未審核  2：尚未派工  3：尚未結案    4：已經結案    5：退單
                    if (calEvent.value == '1') {
                        jsEvent.css('background-color', '#787878'); //#9E9E9E
                        ...
                        jsEvent.css('background-color', '#cccccc');
                    }
                },
                events: function (start, end, timezone, callback) {
                    $.ajax({
                        url: '0030010007.aspx/GetClassGroup',
                        type: 'POST',
                        //async: false,
                        data: JSON.stringify({
        ...
        function bindTable(date, type, id) {
            ...
            $.ajax({
                url: '0030010007.aspx/GetClassScheduleList',
                type: 'POST',
                //async: false,
                data: JSON.stringify({
    ...
    <h2><strong>&nbsp; &nbsp; 維護單修改或轉派&nbsp; &nbsp;</strong>
    </h2>
    &nbsp;&nbsp;&nbsp;
    <button type="button" onclick="Xin_De()" class="btn btn-success btn-lg"><span class='glyphicon glyphicon-plus'></span>&nbsp;&nbsp;新增本月維護單</button>
    ...
    <div class="table-responsive" style="width: 1280px; margin: 10px 20px">
        ...
        <div style="float: right;">
            <a id="btn_a" href="0030010007.aspx" class="btn btn-warning btn-lg"><span class='glyphicon glyphicon-search'></span>&nbsp; &nbsp;整天</a>&nbsp;
            <a id="btn_b" href="0030010007.aspx?str_time=1" class="btn btn-warning btn-lg"><span class='glyphicon glyphicon-search'></span>&nbsp; &nbsp;上午</a>&nbsp;
            <a id="btn_c" href="0030010007.aspx?str_time=2" class="btn btn-warning btn-lg"><span class='glyphicon glyphicon-search'></span>&nbsp; &nbsp;下午</a>
        </div>
        <div id="calendar"></div>
    </div>
</asp:Content>
