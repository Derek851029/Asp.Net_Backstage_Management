...
<asp:Content ID="Content" ContentPlaceHolderID="head2" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            ShowTime();  //抓現在時間
            if (seqno != '0') {         //seqno 不等於0時 Load_MNo();   其他 開
                Load_MNo();
            } else {
        ...
        function Data_Save() {
            ...
            var str_esti_fin_time = document.getElementById("EstimatedFinishTime").innerHTML;
            ...
            var str_rep = document.getElementById("Reply").innerHTML;
                ...
                <tr>
                    ...
                    <th style="width: 35%">
                        <div data-toggle="tooltip" title="必選" style="width: 100%">
                            <select id="SelectTelecomm" name="SelectTelecomm" class="chosen-select" onchange="ShowClientData()">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <tr style="height: 55px;">
                    ...
                    <td style="width: 35%">
                        <label id="EstimatedFinishTime"></label>
                    </td>
                ...
                <tr style="height: 55px;">
                    ...
                    <th style="width: 35%">
                        <div data-toggle="tooltip" title="必選" style="width: 100%">
                            <select id="SelectOpinionSource" name="SelectOpinionSource" class="chosen-select">
                ...
                <tr style="height: 55px;">
                    ...
                    <td>
                        <div style="float: left" data-toggle="tooltip" title="必填，不能含有不正確的符號">
                            <textarea id="Opinion" name="Opinion" class="form-control" cols="45" rows="3" placeholder="意見內容" maxlength="" onkeyup="cs(this);"
                                style="resize: none; background-color: #ffffbb"></textarea>
                        </div>
                    </td>
                    <td style="text-align: center">
