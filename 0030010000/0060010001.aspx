        ...
        function Safe(Flag) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    ...
                    REGISTER_ADDR: REGISTER_ADDR, CONTACT_ADDR: CONTACT_ADDR, CycleTime: CycleTime,
                    ...
                    LAC: LAC,//Licence_Name: Licence_Name, 
        ...
        function New(Flag) {
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    ...
                    APPNAME_2: APPNAME_2, //APP_SUBTITLE_2: APP_SUBTITLE_2,
                    APP_MTEL_2: APP_MTEL_2, APP_EMAIL_2: APP_EMAIL_2,
                    REGISTER_ADDR: REGISTER_ADDR, CycleTime: CycleTime, CONTACT_ADDR: CONTACT_ADDR,
                    APP_OTEL: APP_OTEL, APP_FTEL: APP_FTEL,
                    INVOICENAME: INVOICENAME, Inads: Inads,
                    HardWare: HardWare, SoftwareLoad: SoftwareLoad,
                    Mail_Type: Mail_Type, 
                    ...
                    Salse_TEL: Salse_TEL, SID: SID,
                    Serial_Number: Serial_Number, License_Host: License_Host,
                    LAC: LAC,   //Licence_Name: Licence_Name, OE_Number: OE_Number,
                    Our_Reference: Our_Reference, Your_Reference: Your_Reference,
                    Auth_File_ID: Auth_File_ID, Telecomm_ID: Telecomm_ID,
                    FL: FL, Group_Name_ID: Group_Name_ID,
                    SED: SED, SERVICEITEM: SERVICEITEM,
 ...
 <%--                               <th style="text-align: center; width: 15%; height: 55px;">
                                ...
                                <th style="text-align: center; width: 35%">
                                    <div style="float: left" data-toggle="tooltip" title="">
                                        <input type="text" class="form-control" id="datetimepicker01" name="time_01" style="" />
                                    </div>
                                </th> --%>
                            </tr>
                    ...
                    <table id="Table2" class="display table table-striped" style="width: 99%">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;">維護客戶名稱</th>
        ...
        <table id="data" class="display table table-striped" style="width: 99%">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center; width: 10%">建檔日期</th>
                    <!--<th style="text-align: center;">異動者</th>-->
                    <th style="text-align: center; width: 10%">異動日期</th>
        ...
        <div class="modal-dialog" style="width:  1200px;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title"><strong>維護客戶（新增）</strong></h2>
                            ...
                            <tbody>
                                ...
                                <tr style="height: 55px;">
                                    <th style="text-align: center; width: 15%">
                                        <strong>維護週期</strong></th>
                                    <th style="width: 35%">
                                        <select id="New_CycleTime2" name="New_CycleTime" class="form-control"
                                            style="width: 100%; Font-Size: 18px; background-color: #ffffbb; color: #333333;">
                                            <option value="">請選擇維護週期…</option>
                                            <option value="0">單月</option>
                                            <option value="1">雙月</option>
                                ...
                                <tr style="height: 55px;">
                                    <div class='checkbox'>
                                        <label>
                                            <input id='Flag' type='checkbox' style='width: 30px; height: 30px;' />
                                        </label>
                                    </div>
