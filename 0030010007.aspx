...
/*        function ALL() {
 ...
 /*       function Select_Telecomm() {
  ...
  /*                             , {
                                    data: "", render: function (data, type, row, meta) {
                                        return "<button type='button' class='btn btn-success btn-lg' data-toggle='modal' data-target='#newModal' style='Font-Size: 20px;' id='edit2' class='btn btn-info btn-lg'>" +
                                " <span class='glyphicon glyphicon-plus'>取消</button>";
                                    }
                                }   //  */
                        ]
                    });
...
//document.getElementById("str_com_tel").innerHTML = "("+ obj.data[0].E + ")" + obj.data[0].F;
 ...
 /*       function ShowCaseData() {
        ...
        function Labor_Delete(SYS_ID) {
            $.ajax({
                url: '0030010005.aspx/Labor_Delete',
                type: 'POST',
...
/*        function Load_MNo() {
       ...
       //================   Load_CaseData()       
        function Load_OE_Data() {          
            ...
            document.getElementById('Table1').style.display = "";  //顯示 Modal_1
            //str_title = "修改";
            $.ajax({
                ...
                success: function (doc) {
                    ...
                    //style('DropService', obj.data[0].Service);
                    //ServiceChanged();
                    //document.getElementById("txt_SYS_ID").value = obj.data[0].OE_Case_ID;
                    ...
                    //document.getElementById("LoginTime").value = obj.data[0].UpdateDate;
                    document.getElementById("txt_Type_Value").value = obj.data[0].Type_Value;
                    document.getElementById("txt_Type").value = obj.data[0].Type;

                    //document.getElementById("DropClientCode").value = obj.data[0].PID;
                    ...
                    //     document.getElementById("DropSubsidiaryCode").value = obj.data[0].PNumber;
...
<!--<input type="text" class="form-control" id="Text2" name="LoginTime" style="background-color: #ffffbb" value=""/>-->
                ...
                <tr>
                    ...
                    <td>
                        <div style="float: left" data-toggle="tooltip" title="值請輸入單一數字, 狀態最多四個字">
                            <input type="text" class="form-control" id="txt_Type_Value" name="txt_Type_Value" maxlength="1" style="background-color: #ffffbb" value="" />
                        </div>
                    </td> 
                    <td style="text-align: center">
                        <strong>表單狀態</strong>
                    ...
                    <td>
                        <div style="float: left" data-toggle="tooltip" title="暫訂 尚未領料:1,尚未完工:2,已經完工:3,已經驗收:4,已經結案:5 也可另行決定">
                            <input type="text" class="form-control" id="txt_Type" name="txt_Type" maxlength="8" style="background-color: #ffffbb" value="" />
                        </div>
                    </td>                    
                </tr>                
            </tbody>
       ...
       <table  id="data" class="display table table-striped" style="width: 99%">            
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;" width: 32%;>商品名稱</th>
...
<%--  =========== 表單六 =開關               ========--%>
    <div style="text-align: center; width: 640px; margin: 10px 20px">
        <h2><label id="Label1"></label></h2>
        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th style="text-align: center" colspan="4">
                        <span style="font-size: 20px"><strong>商品總價</strong></span>
                    </th>
                </tr>
            </thead>
            <tbody>
            ...
            <thead>
                <tr>
                    <th style="text-align: center" colspan="4">                                                             <%--  Table 003  --%>
                        <span style="font-size: 20px"><strong>處理狀態</strong></span>
                    </th>
                </tr>
            </thead>
            <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    <div style="float: left" data-toggle="tooltip" title="必填">
                                        ...
                                        <input type="text" class="form-control" id="Text3" name="LoginTime" style="background-color: #ffffbb" value="" />
                                    </div>
                                </th>
                                <th style="text-align: center; width: 15%; height: 65px;">
                                    <strong>建檔日期</strong>
  ...
  <%--       <table class="table table-bordered table-striped">
        ...
        <div style="text-align: center">
            ...
            <button id="Button2" type="button" onclick="Btn_New_Click('1');" class="btn btn-primary btn-lg "><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;修改</button>&nbsp; &nbsp;                        
