<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="~/0030010009.aspx.cs" Inherits="_0030010009" %>
...
/*        function ALL() {
 ...
 /*       function Service_List() {
            $.ajax({
                url: '0030010009.aspx/Service_List',
                type: 'POST',
                contentType: 'application/json; charset=UTF-8',
                dataType: "json",
                success: function (doc) {
 ...
 /*       function ServiceChanged() {
            ...
            $.ajax({
                url: '0030010009.aspx/ServiceName_List',            // ???
                type: 'POST',
        ...
        function ServiceNameChanged() {
            ...
            $.ajax({
                url: '0030010009.aspx/ServiceName_Flag',
                type: 'POST',
 ...
 /*       function Select_Telecomm() {
            $.ajax({
                url: '0030010009.aspx/Select_Telecomm',
                type: 'POST',
                contentType: 'application/json; charset=UTF-8',
                dataType: "json",
                success: function (doc) {
        ...
        function Client_Code_Search2() {
            ...
            //alert(str_index2);
            $.ajax({
                url: '0030010009.aspx/Client_Code_Search2',
                type: 'POST',
        ...
        function bindTable2() {            //案件列表程式
            ...
            $.ajax({
                url: '0030010009.aspx/GetOEOrder',
                type: 'POST',
        ...
        function OE_Total_Price() {
            ...
            //alert(Main);
            $.ajax({
                url: '0030010009.aspx/OE_Total_Price',
                type: 'POST',
                data: JSON.stringify({ OE_Case_ID: OE_Case_ID }),
                contentType: 'application/json; charset=UTF-8',
                dataType: "json",
        ...
        function ShowClientData() {
            ...
            var str_index = document.getElementById("DropClientCode").value;
            $.ajax({
                url: '0030010009.aspx/Show_Client_Data',
                type: 'POST',
...
//document.getElementById("str_com_tel").innerHTML = "("+ obj.data[0].E + ")" + obj.data[0].F;
        ...
        function ShowSubsidiaryData() {
            ...
            $.ajax({
                url: '0030010009.aspx/Show_Client_Data2',
                type: 'POST',
 ...
 /*       function ShowCaseData() {
            ...
            $.ajax({
                ...
                success: function (doc) {
                    ...
                    if (json.status == "new") {
                        ...
                        alert('修改完成');
                        //window.location.href = "/0030010000/0030010009.aspx";
                    }
                    else {
                        //alert(json.status);
                        URL3();
        ...
        function Data_Update(Flag) {                  //右方 存入 左方
            ...
            $.ajax({
                url: '0030010009.aspx/Case_Save2',
                type: 'POST',
                data: JSON.stringify({
                    Flag: Flag,
                    sysid: str_sysid,
        ...
        function Owner_List() {
            $.ajax({
                url: '0030010009.aspx/Owner_List',
                type: 'POST',
                contentType: 'application/json; charset=UTF-8',
                dataType: "json",
                success: function (doc) {
        ...
        function Hospital_List() {
            $.ajax({
                url: '0030010009.aspx/Hospital_List',
                type: 'POST',
                contentType: 'application/json; charset=UTF-8',
                dataType: "json",
                success: function (doc) {
        ...
        function Labor_add(SYSID, Flag) {
            var MNo = new_mno;
            $.ajax({
                url: '0030010009.aspx/Labor_Value',
                type: 'POST',
                ...
                success: function (doc) {
                    ...
                    if (json.status != "null") {
                        ...
                        //=============== 帶入【已選擇的雇主或外勞（瀏覽）】資訊 ===============
                        $.ajax({
                            url: '0030010009.aspx/Btn_Add_Click',
                            type: 'POST',
 ...
 /*       function Btn_New_Click(Flag) {
            ...
            $.ajax({
                url: '0030010009.aspx/Check_Form',
                type: 'POST',
                data: JSON.stringify({
                    Flag: Flag,
...
/*        function Load_MNo() {
       ...
       //================   Load_CaseData()       
        function Load_OE_Data() {          
            ...
            //str_title = "修改";
            $.ajax({
                url: '0030010009.aspx/Load_OEData',
                type: 'POST',
                data: JSON.stringify({ OE_Case_ID: OE_Case_ID }),
                contentType: 'application/json; charset=UTF-8',
                dataType: "json",       //如果要回傳值，請設成 json
        ...
        function Btn_Cancel_Click() {
            ...
            $.ajax({
                url: '0030010009.aspx/Btn_Cancel_Click',
                type: 'POST',
        ...
        function Location(Type) {
            $.ajax({
                url: '0030010009.aspx/Location_List',
                type: 'POST',
        ...
        function Add_Location(ID, Flag) {
            $.ajax({
                url: '0030010009.aspx/Add_Location',
                type: 'POST',
