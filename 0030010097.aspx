...
<asp:Content ID="Content" ContentPlaceHolderID="head2" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Reach(Flag) {      //原 Data_Save
            ...
            var p_reason = document.getElementById("Patch_Reason").value;
            $.ajax({
                ...
                success: function (doc) {
                        ...
                        columns: [
                                ...
                                },
                                {
                                    data: "", render: function (data, type, row, meta) {
                                        ...
                                        " <span class='glyphicon glyphicon-plus'>更換</button>";
                                    }
                                }
                        ]
                    });
                    $('#Table1 tbody').unbind('click').   // ???
                        on('click', '#edit', function () {
                            ...
                            //var Price = table.row($(this).parents('tr')).data().Price.toString(); //固定價格
                            //var pri = ("price_" + ID);
                            //var Price = document.getElementById(pri).value; //手填價格
                            var Price = 0;
                            var txt = "txt_" + ID;
        ...
        function Catch_Reason() {
            document.getElementById("Patch_Reason").value = document.getElementById("select_Reason").value
            /*var A= document.getElementById("select_Reason").value
            var B = document.getElementById("Patch_Reason").value
            alert("A=" + A);
            alert("B=" + B);//*/
        }
                ...
                <tr style="height: 55px;">                    
                    ...
                    <td colspan="3">
                        ...
                        <div style="float: left; width: 100%" data-toggle="tooltip" title="不能超過1000 個字">
                            <textarea id="PS" name="PS" class="form-control" cols="120" rows="5" placeholder="結案時工程師填" maxlength="1000" 
        ...
        <div style="text-align: center; width: 1280px; margin: 10px 20px">
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th style="text-align: center" colspan="4">
                            <span style="font-size: 20px"><strong>更換零件 類別選擇</strong></span>
                        </th>
                    </tr>
                </thead>
                <tbody>
       ...
       <table  id="Table1" class="display table table-striped" style="width: 99%">            
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;" width: 8%;>更換</th>
                </tr>               
            </thead>
        </table>
    </div>
                        ...
                        <thead>
                            <tr>
                                <th style="text-align: center" colspan="2">
                                    <span style="font-size: 20px"><strong>補登記內容</strong></span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th style="text-align: center; width: auto; height: 55px;">
                                    <strong>登記時間</strong>
                                </th>
                                <th>
                                    <div style="float: left" data-toggle="tooltip" title="">
                            ...
                            <tr>
                                <th style="text-align: center; width: 20%; height: 55px;">
                                    <strong>選擇補單原因<br />(自動填寫)</strong>
                                </th>
                                <th style="text-align: center; width: 80%">
                                    <select id="select_Reason" name="select_Reason" class="form-control" onchange="Catch_Reason();" style="Font-Size: 18px">
                                        <option value="">請選擇補單原因…</option>
                                        <option value="假日補單">假日補單</option>
                                        <option value="未準時登記">未準時登記</option>
                                    </select>
                                </th>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: center; width: auto">
                                    <div style="float: left" data-toggle="tooltip" title="必填，不能超過２５０個字元">
                                        <textarea id="Patch_Reason" name="Patch_Reason" class="form-control" cols="50" rows="3" placeholder="補單原因" 
                                            maxlength="250" onkeyup="cs(this);" style="resize: none;" hidden="hidden"></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
