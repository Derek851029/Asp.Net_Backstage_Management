...
//            "HardWare, SoftwareLoad, SERVICEITEM, SalseAgent, CONTACT_ADDR, MEMO " +
    ...
    [WebMethod(EnableSession = true)]//或[WebMethod(true)]
    public static string Reach(string sysid, string time, string Flag)
    {
        string Type_Value = "2";
        string Type = "處理中";
        string Time_01 = "";
    ...
    [WebMethod(EnableSession = true)]//或[WebMethod(true)]
    public static string Finish(string sysid, string ps, string C_Name, string S_O_Type, string time, string Flag)
    {
        string Type_Value = "3";
        string Type = "已結案";
        string Time_02 = "";
