...
<asp:Content ID="Content" ContentPlaceHolderID="head2" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            Load();
            //Select_Telecomm();    //選電信商
            //List_Dispatch_Team();   //選部門
            Change_Dispatch();
            Client_Code_Search();       //選客戶
            ShowTime();             //抓時間         
            document.getElementById("Chose_Company").innerHTML = "Engineer";
            if (seqno != '0') {
                document.getElementById('Button1').style.display = "none";  //隱藏確定鈕
                document.getElementById('Button6').style.display = "none";  //隱藏派工並存檔
                document.getElementById('Button7').style.display = "none";  //隱藏 補單號 鈕
                document.getElementById("str_title").innerHTML = "(修改)服務單作業";
                document.getElementById("Label2").innerHTML = "客服處理回覆"+"<br />"+" 或取消原因";
                Load_Data();
                document.getElementById('Upload_Table').style.display = ""; //顯示檔案上傳
            }
            else {
                document.getElementById("str_title").innerHTML = "(新增)服務單作業";
                document.getElementById("Label2").innerHTML = "客服處理回覆";
                document.getElementById('Button2').style.display = "none";  //隱藏修改鈕
                document.getElementById('Button4').style.display = "none";  //隱藏派工
                document.getElementById('Button5').style.display = "none";  //隱藏轉派工
                document.getElementById("DealingProcess").innerHTML = "未到點";
                document.getElementById('Button8').style.display = "none";
                document.getElementById('Upload_Table').style.display = "none"; //隱藏檔案上傳
            }
        });
        ...
        function Load_Data() {
            ...
            $.ajax({
                ...
                success: function (doc) {
                    ...
                    document.getElementById("Text1").value = obj.data[0].Text1;
                    document.getElementById("Text2").value = obj.data[0].Text2;     // 來電號碼+建單人            
                    //document.getElementById("LoginTime').innerHTML = obj.data[0].str_login_time ; //時間會自動抓

                    style('DropClientCode', obj.data[0].str_client_id);     //選項用?
                    document.getElementById("Label1").innerHTML = obj.data[0].str_client_id;
                    ...
                    document.getElementById("Service_Location").value = obj.data[0].str_addr;
                    document.getElementById("str_contact").value = obj.data[0].str_appname;
                    document.getElementById("str_mob_phone").value = obj.data[0].str_appmtel;
                    document.getElementById("str_telecomm_id").innerHTML = obj.data[0].str_T_ID;
                    document.getElementById("txt_Email").value = obj.data[0].str_appemail;
                    ...
                    document.getElementById("str_I_PS").value = obj.data[0].str_i_ps;

                    //document.getElementById("SelectUrgency").value = obj.data[0].str_urgency;
                    /*if (obj.data[0].str_urgency != '維護' && obj.data[0].str_urgency != '緊急故障' && obj.data[0].str_urgency != '重要故障'
                        && obj.data[0].str_urgency != '一般故障')
                    {
                        style('SelectUrgency', '其他');
                        document.getElementById("Urgency2").value = obj.data[0].str_urgency;
                    }
                    else//*/
                        style('SelectUrgency', obj.data[0].str_urgency);                    
                    document.getElementById("datetimepicker01").value = obj.data[0].str_onspot_time;
                    //document.getElementById("SelectOpinionType").value = obj.data[0].str_op_type;
                    ...
                    if (obj.data[0].str_typ == "取消")
                        document.getElementById('Button8').style.display = "none";  //隱藏轉派工
                    ...
                    document.getElementById("UserID").value = obj.data[0].str_UserID;
                    if(obj.data[0].str_ps !="")
                        document.getElementById("PS").value = obj.data[0].str_ps;
                    document.getElementById("Reply").value = obj.data[0].str_rep;
                    ...
                    if (obj.data[0].str_A_ID != "") {
                        document.getElementById('Button4').style.display = "none";  //隱藏
                    }
                    else document.getElementById('Button5').style.display = "none";  //隱藏
        ...
        function Select_Telecomm() {    // 沒在用 SQL Telecomm 功用不明
            $.ajax({
        ...
        function Client_Code_Search2() {    //選子公司
            ...
            //alert(str_index2);
            $.ajax({
                url: '0030010099.aspx/Client_Code_Search2',
                type: 'POST',
        ...
        function ShowClientData() {     //選顧客後抓資料
            ...
            $.ajax({
                ...
                success: function (doc) {
                    ...
                    document.getElementById("Warr_Time").innerHTML = obj.data[0].P;
                    document.getElementById("Prot_Time").innerHTML = obj.data[0].Q;
                    document.getElementById("str_I_PS").value = obj.data[0].R;
                }
            });
        }
        ...
        function ShowSubsidiaryData() {
            ...
            $.ajax({
                url: '0030010099.aspx/Show_Client_Data2',
                type: 'POST',
        ...
        function List_Record(id) {  //列出顧客案件
            $.ajax({
                url: '0030010099.aspx/List_Record',
                type: 'POST',
        ...
        function Data_Save() {
            ...
            var str_client_id = document.getElementById("Label1").innerHTML;
            ...
            var str_I_PS = document.getElementById("str_I_PS").value;

            var str_urgency = document.getElementById("SelectUrgency").value;
            //if (str_urgency =="其他")
                //str_urgency = document.getElementById("Urgency2").value;
            ...
            //var str_type = document.getElementById("DealingProcess").innerHTML;
            var str_A_ID = document.getElementById("A_ID").innerHTML;
            var str_Handle_Agent = document.getElementById("A_N").innerHTML;
            var str_UserID = document.getElementById("UserID").value;
            ...
            $.ajax({
                ...
                success: function (doc) {
                    ...
                    if (json.status == "new") {
                        //alert('新增完成');
                        //URL();
                        window.location.href = "/0030010000/0030010002.aspx";     //網址錯了 卻會轉跳?
                    }
        ...
        function Data_Update() {
            ...
            //$("#Div_Loading").modal();
            $.ajax({
                url: '0030010099.aspx/Case_Update',
                type: 'POST',
                data: JSON.stringify({
                    sysid: str_sysid,
                    sysid2: str_sysid2,
                ...
                error: function () { alert("修改服務單發生錯誤"); }
            });
        }
        ...
        function List_Dispatch_Team() {     //選派工部門選項(停用)
            $.ajax({
                url: '0030010099.aspx/List_Dispatch_Team',
                type: 'POST',
                contentType: 'application/json; charset=UTF-8',
                dataType: "json",
                success: function (doc) {
    ...
    <div style="width: 1280px; margin: 10px 20px">
        <h2><label id="str_title"></label>
            <button id="Button7" type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal" 
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr style="height: 55px;">
                    ...
                    <th style="width: 35%">
                        <div style="float: left" data-toggle="tooltip" title="必填，不能超過100 個字，且不能含有不正確的符號">
                            <textarea id="Service_Location" name="Service_Location" class="form-control" cols="45" rows="1" placeholder="叫修地址" maxlength="100" onkeyup="cs(this);"
                ...
                <tr style="height: 55px;">
                    ...
                    <td>
                        ...
                        <div style="float: left" data-toggle="tooltip" title="必填">
                            <input type="text" class="form-control" id="str_contact" name="Contact" style="background-color: #ffffbb" maxlength="25" value="" />
                        </div>
                    </td>
                    <td style="text-align: center">
                        <strong>聯絡人電話</strong>
                    ...
                    <td>
                        ...
                        <div style="float: left" data-toggle="tooltip" title="必填">
                            <input type="text" class="form-control" id="str_mob_phone" name="Contact_mob_phone" style="background-color: #ffffbb" maxlength="25" value="" />
                        </div>
                    </td>
                </tr>
                <%--  =========== 勞工資料 ===========--%>
                <tr style="height: 55px;">
                    ...
                    <td>
                        <input type="text" class="form-control" id="txt_Email" name="txt_Email" maxlength="100" value="" style="width: 80%; " />
                    </td>
                </tr>
                <%--  =========== 勞工資料 ===========--%>
                <tr style="height: 55px;">
                ...
                <tr style="height: 55px;">
                    ...
                    <td>
                        <label id="Warr_Time"></label>
                    </td>
                    <td style="text-align: center">
                        <strong>維護終止日</strong>
                    </td>
                    <td>
                        <label id="Prot_Time"></label>
                    </td>
                </tr>
                <%--  =========== 勞工資料 ===========--%>
                <tr style="height: 55px;">
                    ...
                    <td style="text-align: center">
                        <strong>客戶資訊備註</strong>    <!--（搭配經銷商） -->
                    </td>
                    <td style="text-align: center; ">
                        <div style="float: left" data-toggle="tooltip" title="不能超過1000 個字">
                            <textarea id="str_I_PS" name="str_I_PS" class="form-control" cols="50" rows="5" placeholder="客戶資訊備註" maxlength="1000" onkeyup=""
    ...
    <!--<div style="text-align: center; width: 1280px; margin: 10px 20px">
        <table class="table table-bordered table-striped">                      
            ...
            <tbody>
                ...
                <tr style="height: 55px;">                                                          <%--  Table 002-2  --%>
                    ...
                    <td>
                        <input type="text" class="form-control" id="str_contact_2" name="str_contact" maxlength="25"  placeholder="(子)聯絡人"/>  
                    </td>
                    <td style="text-align: center">
                ...
                <tr style="height: 55px;">
                    ...
                    <td>
                        <input type="text" class="form-control" id="str_mob_phone_2" name="str_contact" maxlength="25"  placeholder="(子)聯絡電話"/>  
                    </td>
                    <td style="text-align: center; width: 15%">
                        <strong>(子)地址</strong>
                    </td>
                    <td style="width: 35%">                                         
                        <div style="float: left" data-toggle="tooltip" title="不能超過100 個字，且不能含有不正確的符號">      
                                <textarea id="str_C_addr_2" name="str_C_addr_2" class="form-control" cols="45" rows="1" placeholder="地址" maxlength="100" onkeyup="cs(this);"
                                style="resize: none; "  ></textarea>
                        </div>
                    </td>
                </tr>
        ...
        <table id="tab_Record" class="display table table-striped" style="width: 99%">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;" width: 15%;>登單時間</th>
                    <th style="text-align: center;" width: 15%;>客戶名稱</th>
                    <th style="text-align: center;" width: 15%;>意見內容</th>
                    <th style="text-align: center;" width: 15%;>備註</th>
                    <th style="text-align: center;" width: 15%;>處理回覆</th>
            ...
            <tbody>
                <tr style="height: 55px;">
                    ...
                    <td style="text-align: center; width: 35%">
                        <!--<div style="float: left" data-toggle="tooltip" title="上限25字">
                            <input type="text" class="form-control" id="Urgency2" name="Urgency2" maxlength="25"  placeholder="選其他時填寫"/>  
                        </div>-->                        
                    </td>-->
                </tr>
                <tr>
                ...
                <tr style="height: 55px;">
                    ...
                    <td>
                        <div style="float: left" data-toggle="tooltip" title="">
                            <textarea id="PS" name="PS" class="form-control" cols="45" rows="3" placeholder="結案時工程師填" maxlength="400" onkeyup="cs(this);"
                                style="resize: none;"></textarea>
                        </div>
                    </td>
                </tr>       -->
        ...
        <!-----------------  檔案上傳表----------->
        <table id="Upload_Table" class="table table-bordered table-striped" >
            <thead>
                <tr>
                    <th style="text-align: center" colspan="4">
                        <span style="font-size: 20px"><strong>檔案上傳</strong></span>
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr id="Tr_upload">
                    <th style="text-align: center; width: 15%;">選擇上傳檔案</th>
                    <th style="text-align: center; width: 35%;">
                        <!--<input type="file" id="myFile" name="myFile" runat="server" />-->
                        <asp:FileUpload ID="FileUpload1" runat="server" />
                    </th>
                    <th style="text-align: center; width: 15%;">檔案上傳</th>
                    <th style="width: 35%;">
                        <asp:Button ID="btnUpload" runat="server" OnClick="btnUpload_Click" Text="檔案上傳" class="btn btn-primary btn-lg" />
                    </th>
                </tr>
                <tr id="Tr_upload2">
                    <th style="text-align: center; width: 15%;">檔案下載</th>
                    <th style="width: 35%;">
  ...
  <!--              <tr>
        ...
        <!-- -->
        <div style="text-align: center">
            <button id="Button6" type="button" onclick="Send_Save();" class="btn btn-success btn-lg ">&nbsp;派 工&nbsp;</button>   
            <button id="Button4" type="button" onclick="Send();" class="btn btn-success btn-lg ">&nbsp;派工&nbsp;</button>
            <button id="Button5" type="button" onclick="Change();" class="btn btn-default btn-lg ">&nbsp;轉派工&nbsp;</button>
        </div>
        <!-- --> 
        <table class="table table-bordered table-striped">
            <thead>
                ...
                <tr style="height: 55px;">
                    ...
                    <th style="width: 35%">
                        <div style="float: left" data-toggle="tooltip" title="不能超過250 個字元，並且含有不正確的符號">
                            <textarea id="Reply" name="Reply" class="form-control" cols="45" rows="3" placeholder="客服處理回覆" maxlength="250" onkeyup="cs(this);"
                                style="resize: none;"></textarea>
                        </div>
                    </th>
                    <th style="text-align: center; width: 15%">
 ...
 <%--        <table class="table table-bordered table-striped">
        ...
        <div style="text-align: center">
            ...
            <button id="Button8" type="button" onclick="Cancel();" class="btn btn-danger btn-lg ">
                                <span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;取消服務單</button>
        </div>
