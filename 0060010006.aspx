<%@ Page Language="C#" EnableEventValidation="true" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="0060010006.aspx.cs" Inherits="_0060010006" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="head2" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function bindTable() {
            $.ajax({
                url: '0060010006.aspx/GetDealerList',
                type: 'POST',
                data: JSON.stringify({ }),
        ...
        function Company_List() {
            $.ajax({
                url: '0060010006.aspx/Agent_Company_List',
                type: 'POST',
                contentType: 'application/json; charset=UTF-8',
                dataType: "json",       //如果要回傳值，請設成 json
                success: function (doc) {
        ...
        function Agent_Team_List() {
            $.ajax({
                url: '0060010006.aspx/Agent_Team_List',
                type: 'POST',
                contentType: 'application/json; charset=UTF-8',
                dataType: "json",
                success: function (doc) {
        ...
        function ROLELIST_List() {
            $.ajax({
                url: '0060010006.aspx/ROLELIST_List',
                type: 'POST',
                contentType: 'application/json; charset=UTF-8',
                dataType: "json",
                success: function (doc) {
        ...
        function Button(Agent_ID) {
            ...
            if (Agent_ID == '0') {
                ...
                document.getElementById("txt_title").innerHTML = "經銷商（新增）";
            } else {
                ...
                document.getElementById("txt_title").innerHTML = "經銷商（修改）";
                //===========================================
                $.ajax({
                    url: '0060010006.aspx/DispatchSystem',
                    type: 'POST',
                    data: JSON.stringify({
                        Agent_ID: Agent_ID,
                    }),
                    ...
                    success: function (doc) {
                        ...
                        document.getElementById("PS").value = obj.data[0].PS;
                        document.getElementById("txt_Agent_Name").value = obj.data[0].Agent_Name;
                        document.getElementById("txt_Agent_ID").innerHTML = obj.data[0].Agent_ID;
        ...
        function New_Agent() {
            ...
            var Flag;
            var Agent_ID = document.getElementById("txt_Agent_ID").innerHTML;
            ...
            $.ajax({
                url: '0060010006.aspx/New_Dealer',
                type: 'POST',
                data: JSON.stringify({
                    PS: PS,
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title"><strong>
                        <label id="txt_title">經銷商（新增）</label><label id="txt_Agent_ID"></label></strong></h2>
                </div>
                        ...
                        <thead>
                            <tr>
                                <th style="text-align: center" colspan="4">
                                    <span style="font-size: 20px"><strong>經銷商資料</strong></span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 20%; color: #D50000;">名稱</td>
                                <td style="width: 30%">
                                    <div>
                                        <input id="txt_Agent_Name" class="form-control" placeholder="經銷商名稱" maxlength="50"
                                            style="width: 100%; Font-Size: 18px; background-color: #ffffbb" data-toggle="tooltip" title="必填，不能超過５０個字" />
                                    </div>
                                </td>
                                <td style="width: 20%; color: #D50000;">備註</td>
                                <td style="width: 30%">
                                    <div tyle="float: left" data-toggle="tooltip" title="不能超過50 個字元，並且含有不正確的符號">
                                        <textarea id="PS" name="Reply" class="form-control" cols="45" rows="3" placeholder="經銷商備註"
                                            maxlength="50" onkeyup="cs(this);" style="resize: none;"></textarea>
                                    </div>
                                </td>
                            </tr>
                            <!-- ==========================================
 ...
 <!--                           <tr>
    ...
    <div class="table-responsive" style="width: 95%; margin: 10px 20px">
        <h2><strong>經銷商管理（瀏覽）&nbsp; &nbsp;
            <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal" style="Font-Size: 20px;" onclick="Xin_De()"><span class='glyphicon glyphicon-plus'></span>&nbsp;&nbsp;新增經銷商</button>
