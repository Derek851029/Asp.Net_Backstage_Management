    ...
    <script type="text/javascript">
        ...
        function Update_AF() {
            ...
            for (q = 0; q < 3; q++) {
                ...
                alert(abc[0]);
                /*for (i = 1; i < 6; i++) {
                    txt = document.getElementById("txt_" + alphabet[q] + i).value;
                    ans = document.getElementById("Ans_" + alphabet[q] + i).value;
                    question.push(txt);
                    answer.push(ans);
                    alert(question[i] + "     " + answer[i])
                }   //*/
            //}   //*/
            Update_Answers('A');
            Update_Answers('B');
        ...
        function Update_ALL_New() {
            //alert(SYSID);
            var ID = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"];
            var title = [];
            var question1 = [];
            var question2 = [];
            var question3 = [];
            ...
            var ans4 = "";
            var ans5 = "";
            var agent = document.getElementById("Agent").innerHTML;
            var type = document.getElementById("Type").innerHTML;
            for (i = 0; i < 12; i++) {
                //for (j = 0; j < 3; j++) {
                txt0 = document.getElementById("title_" + ID[i]).innerHTML;
                txt1 = document.getElementById("txt_" + ID[i] + "1").value;
                txt2 = document.getElementById("txt_" + ID[i] + "2").value;
                txt3 = document.getElementById("txt_" + ID[i] + "3").value;
                txt4 = document.getElementById("txt_" + ID[i] + "4").value;
                txt5 = document.getElementById("txt_" + ID[i] + "5").value;
                select1 = document.getElementById("select_" + ID[i] + "1").value;
                select2 = document.getElementById("select_" + ID[i] + "2").value;
                select3 = document.getElementById("select_" + ID[i] + "3").value;
                select4 = document.getElementById("select_" + ID[i] + "4").value;
                select5= document.getElementById("select_" + ID[i] + "5").value;
                ans1 = document.getElementById("Ans_" + ID[i] + "1").value;
                ans2 = document.getElementById("Ans_" + ID[i] + "2").value;
                ans3 = document.getElementById("Ans_" + ID[i] + "3").value;
                ans4 = document.getElementById("Ans_" + ID[i] + "4").value;
                ans5 = document.getElementById("Ans_" + ID[i] + "5").value;
                title.push(txt0);
                question1.push(txt1);
                question2.push(txt2);
                question3.push(txt3);
            ...
            //for (j = 0; j < 12; j++)   alert(ID[j] + " T=" + title[j] + " Q1=" + question1[j] + " T1=" + type1[j] + " A1=" + answer1[j])
            
            //$("#Div_Loading").modal();    //開啟轉轉圖
            $.ajax({
                url: '0250010004.aspx/Update_Answers_New',
                type: 'POST',
                data: JSON.stringify({
                    alphabet: ID, title: title, question1: question1, question2: question2, question3: question3, question4: question4, question5: question5,
                ...
                success: function (doc) {
                    ...
                    if (json.Flag == "1") {
                        ...
                        //alert("A=" + agent + "  T=" + type);
                        //alert("Agent_Name=" + json.Agent_Name);
                        if (agent == json.Agent_Name && type == "維護中")
            ...
            <tbody>
                ...
                <tr>
                    <th style="text-align: center;"colspan="2">
                        <!--<button type="button" class="btn btn-info btn-lg" id="Button4" onclick="Update_AF();">
                            <span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;儲存A~F</button>
                        <button type="button" class="btn btn-info btn-lg" id="Button5" onclick="Update_GL();">
                            <span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;儲存G~L</button>
                        <button type="button" class="btn btn-primary btn-lg" id="Button3" onclick="Update_ALL();">
                            <span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;儲存</button>-->
                        <button type="button" class="btn btn-primary btn-lg" id="Button4" onclick="Update_ALL_New();">
                            <span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;儲存紀錄</button>          
                    </th>
                    <th style="text-align: center;" colspan="2">
                        ...
                        <!--URL2();-->
                        <!--<button type="button" class="btn btn-success btn-lg" id="Button6" onclick="URL3();">
                            <span class="glyphicon glyphicon-search"></span>&nbsp;&nbsp;重整檢查已上傳紀錄</button>-->
                    </th>
                </tr>
            </tbody>
        </table>
