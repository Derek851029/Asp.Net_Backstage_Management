...
/// 派工系統 - 以雇主服務統計 ( 前 10 家 )
/// </summary>
public class ReportRepository_010
{
    #region 屬性
    ...
    public ReportRepository_010(string StartDate, string EndDate, string Create_Team, string Type_Value, string Service, string Service_ID, string OE_Case_ID)
    {
