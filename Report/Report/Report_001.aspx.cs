...
public partial class Report_Report_001 : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (!File.Exists(@"C:\Signature1\" + imagepath + "_sign.jpg"))
        {
            imagepath = "defaultimage";
        }
        string imagepath2 = string.Format("{0}", seqno.Trim());
        logger.Info("Signature" + imagepath2 + ".jpg");
        if (!File.Exists(@"C:\Signature1\" + imagepath2 + "_C_sign.jpg"))
        {
        ...
        Microsoft.Reporting.WebForms.ReportParameter p_12 = new Microsoft.Reporting.WebForms.ReportParameter("ImagePath", @"C:\Signature1\" + imagepath + "_sign.jpg");
        Microsoft.Reporting.WebForms.ReportParameter p_13 = new Microsoft.Reporting.WebForms.ReportParameter("ImagePath2", @"C:\Signature1\" + imagepath2 + "_C_sign.jpg");
        Microsoft.Reporting.WebForms.ReportParameter p_14 = new Microsoft.Reporting.WebForms.ReportParameter("AVAYA", @"C:\DIMAX\images\AVAYA.png");
        Microsoft.Reporting.WebForms.ReportParameter p_15 = new Microsoft.Reporting.WebForms.ReportParameter("Logo", @"C:\DIMAX\images\" + Logo + ".png");
    ...
    public static string UploadPic_C(string imageData)
    {
        try
        {
            ...
            //string company = HttpContext.Current.Session["company"].ToString();
            string name = string.Format("{0:yyyyMMddHHmmss}", DateTime.Now);
            string Pic_Path = (@"C:\Signature1\" + CNo + "_C_sign.jpg");
            //string Pic_Path = (@"118.163.27.22:8080/Signature/" + CNo + "_sign.jpg");
            using (FileStream fs = new FileStream(Pic_Path, FileMode.Create))
            {
                using (BinaryWriter bw = new BinaryWriter(fs))
