...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            &nbsp;&nbsp;&nbsp;
            <button id="Button1" type="button" class="btn btn-primary btn-lg " data-toggle="modal" data-target="#Div_Signature" onclick="Eng();"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;工程師簽名</button>
            <button id="Button3" type="button" class="btn btn-primary btn-lg " data-toggle="modal" data-target="#Div_Signature" onclick="Cus();"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;客戶簽名</button>
