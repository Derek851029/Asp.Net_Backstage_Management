<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_CHT.aspx.cs" Inherits="Report_Report_CHT" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function RE() {
            ...
            window.location.href = '/Report02/Report_001.aspx?seqno=' + str_CNo + '&company=' + str_value;
        }

        function Service_Type() {
            window.location.href = '/Report02/Report_001_Picture.aspx?seqno=' + str_CNo;
        }
        ...
        function Page(sign) {
            $("#Div_Loading").modal();
            window.location.href = '/Report02/sign.aspx?seqno=' + str_CNo + '&sign=' + sign;
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="text-align: center">
            ...
            <button id="Button1" type="button" class="btn btn-primary btn-lg " data-toggle="modal" data-target="#Div1" onclick=";"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;工程師簽名</button>
            <!--<button id="Button3" type="button" class="btn btn-primary btn-lg " data-toggle="modal" data-target="#Div_Signature" onclick="Cus();">
                <span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;客戶簽名</button>         -->
            <button id="Button3" type="button" class="btn btn-primary btn-lg " data-toggle="modal" onclick="Page('1');">
                <span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;客戶簽名</button>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="rptviewer" runat="server" Width="100%" Height="1500px" />
        </div>
        <script>
            $(function () {
                ...
                submitBtn_2.addEventListener("click", function (e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Report_CHT.aspx/UploadPic_C',
                        data: '{ "imageData" : "' + Pic + '" }',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
                        success: function (doc) {
