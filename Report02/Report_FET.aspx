<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_FET.aspx.cs" Inherits="Report_Report_001" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="text-align: center">
            ...
            <button id="Button3" type="button" class="btn btn-primary btn-lg " data-toggle="modal" onclick="Page('2');">
                <span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;客戶簽名</button>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <script>
            $(function () {
                ...
                submitBtn_2.addEventListener("click", function (e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'Report_FET.aspx/UploadPic_C',
                        data: '{ "imageData" : "' + Pic + '" }',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
                        success: function (doc) {
