...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function URL2() {
            $("#Div_Loading").modal();
            window.location.href = "/Report/Report_001.aspx?seqno=" + str_CNo + "&view=" + str_view;
        }
        function URL3() {
            $("#Div_Loading").modal();
                ...
                <div class="row" style="text-align: center; height: 40px">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-primary btn-lg" id="sig-submitBtn" hidden="hidden">客戶簽名完成</button>&nbsp;&nbsp;
                                <button type="button" class="btn btn-primary btn-lg" id="sig-submitBtn2" hidden="hidden">客戶 簽名完成</button>&nbsp;&nbsp;
                                ...
                                <button type="button" class="btn btn-default btn-lg" id="sig-close" onclick="history.back();">關閉簽名板</button>
                    </div>
                </div>
                <!-- ========================================== -->
            </div>
