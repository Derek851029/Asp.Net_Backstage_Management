<%@ Page Language="C#" EnableEventValidation="true" AutoEventWireup="true" MasterPageFile="MasterPage.master" CodeFile="Report_006.aspx.cs" Inherits="Report_006" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="head2" runat="Server">
    ...
    <div style="width: 1280px; margin: 10px 20px">
        <!--===================================================-->
        <h2><strong>【派工系統】雇主服務統計報表</strong></h2>
                ...
                <tr>
                    ...
                    <td style="text-align: center; width: 50%">
                        <asp:DropDownList ID="drop_team" runat="server" class="form-control" DataTextField="Agent_Company" DataValueField="Agent_Company">
                            <asp:ListItem Value="全部">全部門</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
