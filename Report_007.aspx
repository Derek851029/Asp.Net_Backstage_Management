<%@ Page Language="C#" EnableEventValidation="true" AutoEventWireup="true" MasterPageFile="MasterPage.master" CodeFile="Report_007.aspx.cs" Inherits="Report_007" %>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center; width: auto">
                        ...
                        <asp:TextBox ID="txtSearchName" class="form-control" placeholder="搜任務選項" 
                ...
                <tr>
                    ...
                    <td style="text-align: center; width: auto">
                        <asp:DropDownList ID="drop_type" runat="server" class="form-control">
                            ...
                            <asp:ListItem Value="維護中">維護中</asp:ListItem>
                            <asp:ListItem Value="已完成">已完成</asp:ListItem>
                            <asp:ListItem Value="取消">取消</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: center; width: auto">
                        <asp:DropDownList ID="drop_servicename" runat="server" class="form-control">
                            <asp:ListItem Value="">全部維護廠商</asp:ListItem>
                            <asp:ListItem Value="中華電信">中華電信</asp:ListItem>
                            <asp:ListItem Value="遠傳">遠傳</asp:ListItem>
                            <asp:ListItem Value="德瑪">德瑪</asp:ListItem>
                ...
                <tr hidden="hidden">
                    ...
                    <td style="text-align: center; width: auto">
                        <asp:DropDownList ID="drop_opinion_type" runat="server" class="form-control">
                            <asp:ListItem Value="">全部狀態…</asp:ListItem>
                            <asp:ListItem Value="0">單月</asp:ListItem>
                            <asp:ListItem Value="1">雙月</asp:ListItem>
                            <asp:ListItem Value="2">每季</asp:ListItem>
                            <asp:ListItem Value="3">半年</asp:ListItem>
                            <asp:ListItem Value="4">每年</asp:ListItem>
                        </asp:DropDownList>  <!--OnSelectedIndexChanged="drop_service_change"    
