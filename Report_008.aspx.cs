...
public partial class Report_008 : System.Web.UI.Page
{
   ...
   protected void drop_service_change(object sender, EventArgs e)
    ...
    protected ReportRepository_008 CreateReportRepository()
    {
        try
        {
            ...
            return new ReportRepository_008(txt_S_DATETime.Text, txt_E_DATETime.Text, business, type, enginner, o_type, o_content);
        }
        catch
        {
