...
public partial class Report_011 : System.Web.UI.Page
{
    ...
    protected ReportRepository_011 CreateReportRepository()
    {
        try
        {
            ...
            return new ReportRepository_011(txt_S_DATETime.Text, txt_E_DATETime.Text, team, type, service, service_id, OE_Case_ID);
        }
        catch
        {
